...
npm run gate:a11y        # axe-core on a rendered surface  (args: <file|url> [--medium ...])
npm run gate:interactions # drives the page: hover, focus, reduced motion  (args: [baseUrl] [--brand <name>])
